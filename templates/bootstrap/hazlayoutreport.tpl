            ...
            <div class="col-md-12 reportheader">
                <div class="row">
                    <div class="col-md-3 reportbuttons">
                        <div id="{$prev_question}" class="prevvideo"><span>Prev Clip</span></div> <div id="{$next_question}" class="nextvideo"><span class="sr-only">Skip Clip</span></div> <a href="?report=true&amp;id={$smarty.get.review}" id="exittest"><span>Exit Test</span></a>
