            ...
            <div class="col-md-12 reportheader">
                <div class="row">
                    <div class="col-md-3 reportbuttons">
                        {$prev_question} {$next_question} <a href="/student/hazard?{if $instructor}pupil={$smarty.get.pupil}&amp;{/if}report=true&amp;id={$smarty.get.review}" id="exittest"><span>Exit Test</span></a>
